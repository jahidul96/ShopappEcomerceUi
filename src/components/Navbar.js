                ...
                <div className='container navItemWrapper'>
                    ...
                    <div className='navMiddleDiv'>
                        <div>
                            ...
                            <span className='searchBtn'><BiSearch size={20} color={'white'} /></span>
                        </div>
                    </div>
                ...
                showNav && (
                    <div className='smallScreenNavigationStyles'>
                        <div className='smallScreenSearch '>
                            <input className='navbarInput navSmallSearchInput' placeholder='search...' />
                            <button className='smallScreenDownloadBtn'>DownloadApp</button>
                        </div>
